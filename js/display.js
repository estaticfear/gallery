...
import { TWEEN } from "./lib/jsm/libs/tween.module.min.js";
import { TrackballControls } from "./lib/jsm/controls/TrackballControls.js";
import {
  CSS3DRenderer,
  CSS3DObject,
...
function init(images) {
  ...
  const buttonSphere = createTransformationButton(
    "sphere",
    duration,
    targets.sphere,
    -199,
  ...
  const buttonHelix = createTransformationButton(
    "helix",
    duration,
    targets.helix,
    55,
  ...
  const buttonGrid = createTransformationButton(
    "grid",
    duration,
    targets.grid,
    -297,
  ...
  const buttonTable = createTransformationButton(
    "table",
    duration,
    targets.table,
    -199,
...
function createTransformationButton(
  id,
  duration,
  target,
  x,
...
function showImageModal(i, images, randomId) {
  ...
  img.instagram_link === null
    ? instagramLink.css("display", "none")
    : instagramLink.css("display", "block");
